...
![Picture taken at Townhall Presentation](pictures/prof_happy_with_poster.jpg)

#### <ins>Personal Takeaway</ins> *(from left to right of photo)*

*"Learning about GIS has taught us the methods to transform data, figures and maps into a product that allows us to uncover different facets of society and craft our stories of the world from the data"* - Marcus
...
*"Your academic projects hold potential beyond the classroom. They could be the cornerstone of the next groundbreaking startup."* - Prof. Kam
